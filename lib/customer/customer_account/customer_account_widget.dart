...
export 'customer_account_model.dart';
...
class _CustomerAccountWidgetState extends State<CustomerAccountWidget>
  ...
  late CustomerAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerAccountModel());
              ...
              child: Builder(
                builder: (context) {
                  if (_model.isLoadingCompleted == true) {
                    return Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 0.0, 70.0),
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        wrapWithModel(
                                          model:
                                              _model.imageComponentCircleModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: wrapWithModel(
                                    model: _model.darkModeComponent1Model,
