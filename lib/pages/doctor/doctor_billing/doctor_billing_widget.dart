...
class DoctorBillingWidget extends StatefulWidget {
  const DoctorBillingWidget({
    super.key,
  ...
  @override
  State<DoctorBillingWidget> createState() => _DoctorBillingWidgetState();
}

class _DoctorBillingWidgetState extends State<DoctorBillingWidget> {
  late DoctorBillingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctorBillingModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.returnedBookedData = await queryDocBookedTimeRecordOnce(
        queryBuilder: (docBookedTimeRecord) => docBookedTimeRecord
            ...
            .where(
              'date',
              isGreaterThanOrEqualTo: _model.fromDate,
            )
            .where(
              'date',
              isLessThanOrEqualTo: _model.toDate,
            )
            .where(
              'status_cde',
              isEqualTo: 3,
      ...
      // get booking count
      _model.totBookingCount = valueOrDefault<int>(
      ...
      _model.totCost = valueOrDefault<int>(
        valueOrDefault<int>(
            ...
            valueOrDefault<int>(
              FFAppState().subscrptionFee,
              0,
            ),
        0,
      );
      _model.remainingDays = valueOrDefault<int>(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'fpydbfuj' /* اجمالي خدمة الحجوزات المنفذة */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
