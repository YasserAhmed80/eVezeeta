  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.docDocument?.aGov != null) {
        ...
        safeSetState(() {
          _model.tel1TextController?.text = widget.docDocument!.tel1;
          _model.tel1TextController?.selection = TextSelection.collapsed(
              offset: _model.tel1TextController!.text.length);
        });
        safeSetState(() {
          _model.tel2TextController?.text = widget.docDocument!.tel2;
